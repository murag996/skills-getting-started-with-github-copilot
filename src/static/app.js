              ...
              <ul class="participants-list no-bullets">
                ${details.participants.map(email => `
                  <li>
                    ...
                    <span class="delete-participant" title="Remove participant" data-activity="${name}" data-email="${email}" style="cursor:pointer; color:#c62828; margin-left:8px; font-size:18px;">&#128465;</span>
                  </li>
                `).join("")}
              </ul>
            </div>
